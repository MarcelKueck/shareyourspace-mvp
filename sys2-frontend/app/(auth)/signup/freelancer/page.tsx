...
export default function FreelancerSignupPage() {
  ...
  async function onSubmit(values: FormData) {
    ...
    try {
       ...
       // Note: Freelancer form doesn't have companyName, but the API function expects it.
       // We pass it as undefined, which should be handled correctly if optional.
      const createdUser = await registerUser({ ...values, companyName: undefined });
